...
// import {cardQueries}  from "./global.js";
...
$searchBtn.addEventListener("click" ,  function () {
    if($searchFiled.value) window.location = `/recipes.html?q=${$searchFiled.value}`
})


// search submit when we press enter key
          ...
          <div class="card-body">
            ...
            <div class="meta-wrapper">
              <div class="meta-item">
                ...
                <span class="lebel-medium"> ${getTime(cookingTime).time || "<1"} ${getTime(cookingTime).timeUnit}</span>
              </div>
  
  
              <button class="icon-btn has-state ${isSaved ? "removed" : "saved"}" aria-label="Add to saved recipes" onclick="saveRecipe(this, '${recipeId}')" >
...
// button par click karne se save ho jaye local storage main ya nikal jaye local storage se aur yeh button hai saving wala
...
//     const iconBtn = body.querySelector(".icon-btn");
    
//     iconBtn.addEventListener("click", () => {
//       console.log("ander aa gya hoon");
      
//       if (iconBtn) {
        
//         saveRecipe(iconBtn, recipeId);
//       } else {
//         return;
//       }
//     });
...
//fetch data for slider container
